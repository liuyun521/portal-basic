package com.bruce.util.basedao.hbn;
...
public abstract class HibernateFacade extends AbstractFacade<HibernateSessionMgr, Session>
{
	 ...
	 * 执行Session对象的指定方法
	 * 
	 * @param methodName	: Session 的方法名称
	 * @param objs		: 方法参数
	 * @return			: 执行结果
	 * 
	 */
	protected Object execute(String methodName, Object ... objs) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException
	{
		Method m = Session.class.getMethod(methodName, Object.class);
		return m.invoke(getSession(), objs);
	}
